...
import dateutil.tz
import numpy as np
from traj2vec import config
from traj2vec.utils.console import mkdir_p
from traj2vec.utils.ext import AttrDict
from traj2vec.utils.serializable import Serializable
from traj2vec.viskit.core import flatten
...
def run_experiment_lite(
    ...
    for task in batch_tasks:
        ...
        if task.get("log_dir", None) is None:
            ...
            task["log_dir"] = config.LOG_DIR + "/" + task["exp_name"]
