...
from traj2vec.ppo.distributions import Categorical, DiagGaussian
from traj2vec.ppo.running_stat import ObsNorm
...
class MLPPolicy(FFPolicy):
    def __init__(self, num_inputs, action_space):
        ...
        self.obs_filter = ObsNorm((1, num_inputs), demean=False, destd=False, clip=False)
