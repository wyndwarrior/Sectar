...
from traj2vec.envs.wheeled import reward_fn, init_rstate
import tensorflow as tf
import sys
from traj2vec.envs.wheeled import WheeledEnv
...
def get_env(vv):
    return WheeledEnv(goals=np.array(vv['block_config']), 
        include_rstate = True)
...
goals = np.load('goals/wheeled.npy').tolist()
